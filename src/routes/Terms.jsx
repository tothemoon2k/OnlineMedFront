    ...
    return (
        <div className='w-screen h-fit flex flex-col justify-center items-center px-10 relative'>
            ...
            <div className='w-4/5 h-fit py-40'>
                <h1 className='mb-2 text-2xl font-medium text-center'>Terms & Conditions</h1>
                <p className='text-gray-500 text-xl mb-12 text-center'>Last updated September 25, 2024</p>

                <h2 className='mb-6 text-xl font-medium text-center'>AGREEMENT TO OUR LEGAL TERMS</h2>

                <p>We are OnlineMed, doing business as OnlineMed ("Company," "we," "us," "our"). <br /> <br />
We operate the website https://www.onlinemed.io (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
<br /> <br />
You can contact us by phone at (+1)9842047128, email at hello@onlinemed.tech, or by mail to 721 Governor Morrison ST, Charlotte, NC 28211, USA, North Carolina, NC 28211, United States.
</p>

<h2 className='mb-6 text-xl font-medium text-center'>TABLE OF CONTENTS</h2>
<p>1. OUR SERVICES<br />
...
10. GUIDELINES FOR REVIEWS<br />
11. SERVICES MANAGEMENT<br />
...
24. MISCELLANEOUS<br />
25. ONLINEMED POLICY ON UNSUPPORTED DOCUMENTATION REQUESTS<br />
26. CONTACT US</p>
<h2 className='mb-6 text-xl font-medium text-center'>1. OUR SERVICES</h2>
<p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>
<p>Medical Information and Use of Service Nature of Service: This platform is intended to provide excuse notes based on the information provided by the user. It is not meant to diagnose, treat, or give medical advice regarding any illness or condition. Honesty of Information: Users agree to provide accurate and true information about their health and symptoms. Any attempt to mislead or provide false information may result in refusal of service. Limitation of Service: Our service caters to minor illnesses only. For severe symptoms or conditions, it is the responsibility of the user to seek appropriate medical care. This service does not replace the need for regular medical check-ups or consultations with healthcare professionals. Confidentiality: All personal and medical information provided will be kept confidential and will not be shared or sold to third parties. This information will be used solely for the purpose of issuing excuse notes. Regulation and Compliance: This service operates within the legal boundaries and regulations set by health authorities in the state of NY. Users are responsible for ensuring that receiving an excuse note through this platform is accepted by their respective employers or institutions. No Guarantees: Issuance of an excuse note does not guarantee acceptance by employers, educational institutions, or any other entities. It is the user's responsibility to verify acceptance of such notes. Limitation of Liability: OnlineMed will not be liable for any direct, indirect, consequential, or other damages arising out of the use of this service, including, but not limited to, any decisions made or actions taken based on the excuse notes provided.</p>
<h2 className='mb-6 text-xl font-medium text-center'>2. INTELLECTUAL PROPERTY RIGHTS</h2>
...
<p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: rebecca@nyhealthlink.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
...
warrant that any such Submissions are original to you or that you have the necessary rights and licenses to submit such Submissions and that you have full authority to grant us the above-mentioned rights in relation to your Submissions; and<br />
warrant and represent that your Submissions do not constitute confidential information.</p>
...
<h2 className='mb-6 text-xl font-medium text-center'>3. USER REPRESENTATIONS</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>4. PRODUCTS</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>5. PURCHASES AND PAYMENT</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>6. REFUNDS POLICY</h2>
<p>All sales are final and no refund will be issued.</p>
<h2 className='mb-6 text-xl font-medium text-center'>7. PROHIBITED ACTIVITIES</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>8. USER GENERATED CONTRIBUTIONS</h2>
...
<p>The creation, distribution, transmission, public display, or performance, and the accessing, downloading, or copying of your Contributions do not and will not infringe the proprietary rights, including but not limited to the copyright, patent, trademark, trade secret, or moral rights of any third party.<br />
...
Your Contributions do not otherwise violate, or link to material that violates, any provision of these Legal Terms, or any applicable law or regulation.</p>
...
<h2 className='mb-6 text-xl font-medium text-center'>9. CONTRIBUTION LICENSE</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>10. GUIDELINES FOR REVIEWS</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>11. SERVICES MANAGEMENT</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>12. PRIVACY POLICY</h2>
<p>We care about data privacy and security. Please review our Privacy Policy: http://www.OnlineMed.com/privacy. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
<h2 className='mb-6 text-xl font-medium text-center'>13. TERM AND TERMINATION</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>14. MODIFICATIONS AND INTERRUPTIONS</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>15. GOVERNING LAW</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>16. DISPUTE RESOLUTION</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>17. CORRECTIONS</h2>
<p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
<h2 className='mb-6 text-xl font-medium text-center'>18. DISCLAIMER</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>19. LIMITATIONS OF LIABILITY</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>20. INDEMNIFICATION</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>21. USER DATA</h2>
<p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
<h2 className='mb-6 text-xl font-medium text-center'>22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>23. CALIFORNIA USERS AND RESIDENTS</h2>
<p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
<h2 className='mb-6 text-xl font-medium text-center'>24. MISCELLANEOUS</h2>
...
<h2 className='mb-6 text-xl font-medium text-center'>25. OnlineMed POLICY ON UNSUPPORTED DOCUMENTATION REQUESTS</h2>
<p>OnlineMed does not provide any documentation or notes for conditions or situations that are not supported by our service. This includes, but is not limited to, requests for the following:</p>
<p>- Medical leave or disability documentation<br/>
- Documentation for legal or court proceedings<br/>
- Travel documentation or letters<br/>
- Emotional support animal letters<br/>
- Any other documentation not directly related to the issuance of an excuse note for a minor illness
</p>
<p>Our service is strictly limited to providing excuse notes for minor illnesses based on the information provided by the user. Any requests for unsupported documentation will be respectfully declined.</p>
<h2 className='mb-6 text-xl font-medium text-center'>26. CONTACT US</h2>
<p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:</p>
<p>OnlineMed<br/>
721 Governor Morrison ST<br/>
Charlotte, NC 28211<br/>
United States<br/>
Phone: (984) 204-7128<br/>
hello@onlinemed.tech</p>
